    ...
    return (
      <div className="w-full ">
          <form  onSubmit={onSubmitHandler}>
              ...
              <textarea type="text" onKeyDown={keyDownHandler} onChange={onChangeHandler} value={description} name='description' className="w-full text-md font-sans font-normal leading-5 px-3 py-3 rounded-md focus:shadow-outline-purple focus:shadow-lg hover:border-blue-500 focus:border-blue-500 bg-gray-50 focus:bg-white text-slate-900 outline-none border border-solid"/>
              </div>
